...
class InstancePublisher:
    ...
    def __init__(self,
        ...
        assert readable_name is None or isinstance(readable_name,
                                                   str), type(readable_name)
        assert instance_name is None or isinstance(instance_name,
                                                   str), type(instance_name)
