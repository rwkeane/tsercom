...
async def mock_run_on_event_loop_replacement(
    ...
    """
    print(
        f"MOCK_RUN_ON_EVENT_LOOP_REPLACEMENT CALLED with func_partial: {func_partial_producing_coro}"
    )
    ...
    if not asyncio.iscoroutine(coro):
        print(
            f"  WARNING: mock_run_on_event_loop_replacement received a non-coroutine: {type(coro)}."
