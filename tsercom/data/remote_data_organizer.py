"""Manages and organizes timestamped data for a single remote endpoint."""
...
class RemoteDataOrganizer(
    ...
    class Client(ABC):
        ...
        def _on_data_available(
            ...
            """Handle callback invoked when new data is processed and available.
    ...
    def caller_id(self) -> CallerIdentifier:
        """Get the `CallerIdentifier` associated with this data organizer.
    ...
    def __on_data_ready_impl(self, new_data: DataTypeT) -> None:
        """Implement internal processing and storage of new data.
    ...
    def get_interpolated_at(self, timestamp: datetime.datetime) -> DataTypeT | None:
        """Interpolate data to the given timestamp using linear interpolation.
