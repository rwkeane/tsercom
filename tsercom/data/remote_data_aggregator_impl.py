    ...
    def get_data_for_timestamp(
        ...
        with self.__lock:
            ...
            for key, organizer_item in self.__organizers.items():
                # Pass only timestamp to organizer's get_data_for_timestamp if its API is different
                # Assuming RemoteDataOrganizer.get_data_for_timestamp takes (timestamp, id=None)
                # If it only takes (timestamp), then this is correct:
