...
class DataTimeoutTracker:
    ...
    class Tracked(ABC):
        ...
        def _on_triggered(self, timeout_seconds: int) -> None:
            """Handle callback invoked when a timeout period elapses.
    ...
    async def __register_impl(self, tracked: Tracked) -> None:
        """Implement internal registration of a 'Tracked' object.
    ...
    def stop(self) -> None:
        """Signal periodic timeout execution to stop. Thread-safe."""
    ...
    async def __signal_stop_impl(self) -> None:
        """Implement internal signal to stop on the event loop."""
