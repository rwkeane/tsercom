...
class RuntimeWrapper(Generic[TDataType, TEventType], RunningRuntime[TDataType, TEventType], RemoteDataReader[TDataType]):
    def __init__(self, runtime : Runtime, data_aggregator = RemoteDataAggregatorImpl[TDataType]):
