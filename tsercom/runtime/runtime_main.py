...
def initialize_runtimes(
    ...
    *,
    ...
    for runtime in runtimes:
        ...
        def _runtime_start_done_callback(f: asyncio.Future, tw_ref: ThreadWatcher):
            try:
        ...
        future.add_done_callback(partial(_runtime_start_done_callback, tw_ref=thread_watcher))
