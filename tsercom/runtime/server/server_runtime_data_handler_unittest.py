...
class TestServerRuntimeDataHandler:
    ...
    def test_init(self, handler_with_mocks, mock_data_reader, mock_event_source_poller):
        handler = handler_with_mocks["handler"]
        TimeSyncServer_class_mock = handler_with_mocks["TimeSyncServer_class_mock"]
        time_sync_server_instance_mock = handler_with_mocks["time_sync_server_instance_mock"]
    ...
    def test_register_caller(
        ...
        expected_clock = handler._ServerRuntimeDataHandler__clock # Internal attribute
        ...
        mock_create_dp_method.assert_called_once_with(mock_caller_id, expected_clock) # Use the direct mock
