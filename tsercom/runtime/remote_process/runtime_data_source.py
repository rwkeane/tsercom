...
class RuntimeDataSource(Generic[TEventType]):
    ...
    def start_async(self, runtime : Runtime[TEventType]):
        ...
        self.__thread_pool = self.__thread_watcher.create_tracked_thread_pool_executor(max_workers = 1)
        ...
        self.__command_thread = self.__thread_watcher.create_tracked_thread(watch_commands)
        self.__event_thread = self.__thread_watcher.create_tracked_thread(watch_events)
