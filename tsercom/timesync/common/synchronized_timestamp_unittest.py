...
def test_try_parse_grpc_timestamp(mocker):
    ...
    expected_datetime = datetime.datetime(2023, 1, 1, 10, 0, 0, tzinfo=datetime.timezone.utc)
    mock_grpc_ts.ToDatetime.return_value = expected_datetime # This mock will now return an aware dt
...
def test_try_parse_server_timestamp():
    ...
    # Make expected_datetime timezone-aware (UTC)
    expected_datetime = datetime.datetime(2023, 1, 1, 11, 0, 0, tzinfo=datetime.timezone.utc)
