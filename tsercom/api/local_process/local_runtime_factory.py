...
class LocalRuntimeFactory(
    ...
    def __init__(
        self,
        initializer: RuntimeInitializer[DataTypeT, EventTypeT], # pylint: disable=C0301
        data_reader: RemoteDataReader[AnnotatedInstance[DataTypeT]], # pylint: disable=C0301
        event_poller: AsyncPoller[EventInstance[EventTypeT]], # pylint: disable=C0301
    ...
    def create(
        ...
        data_handler: RuntimeDataHandler[DataTypeT, EventTypeT], # pylint: disable=C0301
