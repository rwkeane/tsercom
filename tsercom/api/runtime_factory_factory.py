...
class RuntimeFactoryFactory(ABC, Generic[TDataType, TEventType]):
    ...
    def create_factory(self, client : "RuntimeFactoryFactory[TDataType, TEventType].Client", initializer : RuntimeInitializer[TDataType, TEventType]) -> RuntimeFactory[TDataType, TEventType]:
