...
mock_status_code.OK = (
    "StatusCode.OK"  # Add any other codes used or needed for tests
)
...
mock_rpc_status_submodule.from_call = (
    MagicMock()
)  # This function is called by the SUT
...
def test_get_grpc_status_code_rpc_error_with_status():
    ...
    mock_status_obj.code = (
        StatusCode.PERMISSION_DENIED
    )  # google.rpc.Code maps to grpc.StatusCode
