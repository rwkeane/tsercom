...
class TestDiscoverableGrpcEndpointConnector:
    """Tests for DiscoverableGrpcEndpointConnector."""
    ...
    async def test_mark_client_failed_removes_caller_id(
        ...
        mock_aio_utils_fixture["is_running_on_event_loop"].return_value = True
        ...
        mock_aio_utils_fixture["run_on_event_loop"].assert_not_called()
    ...
    async def test_mark_client_failed_uses_run_on_event_loop_if_different_loop(
        ...
        mock_aio_utils_fixture["get_running_loop_or_none"].return_value = (
            mock_target_loop
        )
        mock_aio_utils_fixture["is_running_on_event_loop"].return_value = False

        await connector.mark_client_failed(test_caller_id)
        await asyncio.sleep(0)

        mock_aio_utils_fixture["run_on_event_loop"].assert_called_once()
        call_args_list = mock_aio_utils_fixture["run_on_event_loop"].call_args_list
