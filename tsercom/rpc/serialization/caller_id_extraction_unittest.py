...
class TestCallerIdExtraction:
    ...
    def mock_is_running_tracker(self, mocker):  # Added mocker
        ...
        tracker.create_stoppable_iterator = mocker.MagicMock(
            side_effect=default_stoppable_iterator_impl,
    ...
    def test_extract_id_success_default_extractor(
    ...
    def test_extract_id_missing_id_default_extractor(
    ...
    def test_extract_id_call_object_has_no_id_attr(
    ...
    def test_extract_id_malformed_id_try_parse_returns_none(
        self, mock_servicer_context, mock_call_object, mocker
    ):  # Added mocker
        print(
    ...
    def test_extract_id_with_validation_success(
        self, mock_servicer_context, mock_call_object, mocker
    ):  # Added mocker
        ...
        caller_id = extract_id_from_call(
            ...
            validate_against_id=validate_against_id,
        )
    ...
    def test_extract_id_with_validation_failure(
        self, mock_servicer_context, mock_call_object, mocker
    ):  # Added mocker
    ...
    def test_extract_id_custom_extractor(
        self, mock_servicer_context, mock_call_object, mocker
    ):  # Added mocker
    ...
    async def test_extract_first_success(
        ...
        caller_id, first_call, processed_iterator = (
    ...
    async def test_extract_first_iterator_empty(
        ...
        mock_servicer_context.abort.assert_called_once_with(
            ...
            "First call never received!",  # SUT message changed from CANCELLED
        )
        mock_is_running_tracker.create_stoppable_iterator.assert_called_once_with(
            iterator
        )
