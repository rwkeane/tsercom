...
from tsercom.test.proto.generated.v1_62 import e2e_test_service_pb2 as e2e__test__service__pb2
...
class E2ETestService(object):
    ...
    def Echo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tsercom.E2ETestService/Echo',
    ...
    def ServerStreamData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/tsercom.E2ETestService/ServerStreamData',
    ...
    def ClientStreamData(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/tsercom.E2ETestService/ClientStreamData',
            e2e__test__service__pb2.StreamDataRequest.SerializeToString,
            e2e__test__service__pb2.EchoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BidirectionalStreamData(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/tsercom.E2ETestService/BidirectionalStreamData',
            e2e__test__service__pb2.StreamDataRequest.SerializeToString,
            e2e__test__service__pb2.StreamDataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
