...
class ThreadWatcher:
    ...
    def create_tracked_thread(self,
                              target: Callable[[], None]) -> threading.Thread:
        """
    ...
    def create_tracked_thread_pool_executor(self, *args,
        ...
        """
        return ThrowingThreadPoolExecutor(error_cb=self.on_exception_seen,
                                          *args,
                                          **kwargs)
